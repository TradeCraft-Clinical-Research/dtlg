...
[![CRAN
version](https://www.r-pkg.org/badges/version/dtlg)](https://cran.r-project.org/package=dtlg)
...
[![CRAN downloads last
month](http://cranlogs.r-pkg.org/badges/last-month/dtlg)](https://cran.r-project.org/package=dtlg)
<!-- badges: end -->

`{dtlg}` builds the summary tables that populate Section 14 of a
Clinical Study Report — demographics, adverse event incidence, and
laboratory summaries — from ADaM-like analysis datasets. The compute
backend is data.table, fast enough for interactive Shiny dashboards on
populations of $10^5$ to $10^6$ subjects. Constructors return plain
data.tables, ready to render with kableExtra, gt, DT, or any other
formatter.
